      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div
              class="group-registration__label text-xs tablet:text-base tablet:leading-21px font-bold mt-9px"
            >
              {{
                $t(
            ...
            <Dropdown
              ...
              class="mt-1.5 tablet:max-w-329px"
              :text-button="
            ...
            <Button
              ...
              @click="
                submit({
                  name: 'app-kanrisha-group-id-edit-confirmation',
                })
              "
            >
