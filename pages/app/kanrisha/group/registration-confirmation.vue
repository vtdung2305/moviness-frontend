...
const inforsTrainer = computed(() => {
  return [
    {
      label: t(
        'pages.group_registration_confirmation.trainer_name'
      ),
      value: groupCreateData?.trainer || t('others.empty'),
    },
    {
      label: t(
        'pages.group_registration_confirmation.mail_address'
      ),
      value:
        (trainer && trainer.value?.email) ||
        t('others.empty'),
    },
  ]
})
...
onMounted(() => {
  ...
  if (!groupCreateData?.groupName) {
    router.push({ name: 'app-kanrisha-group-registration' })
  }
})
</script>
  ...
  <PageWrapper class="flex-1 flex">
    <PageBody class="flex-1 flex">
      <PageSection
        ...
        "
      >
        <div class="registration-confirmation laptop:w-3/4">
          <div class="registration-confirmation__container">
            ...
            <CommonInfo
              :title="
                $t(
                  'pages.group_registration_confirmation.trainer_information'
                )
              "
              :src-img="previewImageTrainer"
            ...
            >
              <Button
                ...
                @click="
                  backEdit({
                    name: 'app-kanrisha-group-registration',
                  })
                "
              >
