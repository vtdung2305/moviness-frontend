...
// state
const themeSetting =
  useState<IThemeSettingOptions>('theme.setting')
...
<template>
  <div class="flex items-center">
    ...
    >
      ...
      >
        <span
          class="flex justify-center items-center dark:hidden"
        >
          <IconUil:sun />
        </span>
        <span
          class="justify-center items-center hidden dark:flex"
        >
          <IconUil:moon />
        </span>
      </ListboxButton>
